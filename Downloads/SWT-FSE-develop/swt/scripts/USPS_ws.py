...
def usps_shipping(origin_zip, dest_zip):
    """ Calculate rate
    ...
    if not origin_zip and dest_zip:
    ...
    try:
        ...
        return None  #  proble reaching the usps api. return None. FSE will ignore calculation
    else:
        if res:
